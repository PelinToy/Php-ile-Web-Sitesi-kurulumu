...
<section class="page-section bg-light " id="portfolio">
    <div class="container">
        ...
        <div class="row">
            <?php
            $sorgu2 = $baglanti->prepare("select * from portfolyolarım WHERE aktif=1 Order BY sira");
            $sorgu2->execute();
            while ($sonuc2 = $sorgu2->fetch()) {
                ...
                <div class="portfolio-modal modal fade" id="portfolioModal<?= $sonuc2["id"] ?>" tabindex="-1"
                     role="dialog"
                     aria-hidden="true">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="modal-body">
                                            ...
                                            <img class="img-fluid d-block mx-auto"
                                                 src="assets/img/portfolio/<?= $sonuc2["bfoto"] ?>" alt=""/>
                                            <p><?= $sonuc2["icerik"] ?></p>
